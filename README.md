...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bvs-q4o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bvs-q4o.containers.anotherwebservice.com/
...
```
git clone git@github.com:ryushinmd/container-bvs-q4o.git
cd container-bvs-q4o
```
...
```
docker attach container-bvs-q4o
```
